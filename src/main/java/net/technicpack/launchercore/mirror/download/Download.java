    ...
    public void run() {
        ...
        try {
            ...
            if (responseFamily == 3) {
                ...
                String redirectionLocation = conn.getHeaderField("Location");
                System.out.println("Redirection URL found. New URL: " + redirectionLocation);
                URL redirectURL = new URL(redirectionLocation);
